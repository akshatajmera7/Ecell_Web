    ...
    return (
        <div className="relative w-full min-h-[100dvh] flex items-center justify-center overflow-hidden p-0 m-0 bg-ecell-bg" style={{ pointerEvents: 'auto' }}>
            ...
            <div className="relative z-20 text-center px-6 flex flex-col items-center" style={{ pointerEvents: 'auto' }}>
                <motion.h1
                    className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl font-bold font-startup-header text-center leading-tight mb-0 text-ecell-text"
                ...
                <motion.h2
                    className="text-xl md:text-2xl lg:text-3xl font-startup-body text-center mt-2 text-ecell-text"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}

        ...
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          <div className="lg:w-1/2 bg-blue-600/10 p-6 rounded-lg shadow-lg">
            ...
            <p className="text-lg mb-8">
              With a 50K INR prize pool, the workshop's success lies in its ability to provide a platform for both entrepreneurs and investors to connect and grow in a competitive environment.
            </p>
          </div>

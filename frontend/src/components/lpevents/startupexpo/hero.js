...
const ProductExplorer = () => {
  ...
  onClick={() => { window.location.href = "https://unstop.com/conferences/startup-expo-launchpad-25-birla-institute-of-technology-science-pilani-hyderabad-campus-1317940"; }}
>
  Register Now
</button>
      </div>

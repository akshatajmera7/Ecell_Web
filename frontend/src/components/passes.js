  ...
  const passes = [
    {
      ...
      price: 'FREE',
      originalPrice: '₹199',
      paymentLink: 'https://pmny.in/TrN6D4LfRWxh', 
      features: [
    ...
    },
    {
      ...
      price: '₹499',
      originalPrice: '₹999',
      paymentLink: 'https://pmny.in/TrN6D4LfRWxh', // Replace with actual Gold Pass link
      features: [
        { name: 'Startup Expo', included: true },
        { name: 'LHC Speakers Sessions', included: true },
        { name: 'Informals', included: true },
    ...
    },
    {
      ...
      price: '₹999',
      originalPrice: '₹1499',
      paymentLink: 'https://pmny.in/TrN6D4LfRWxh', // Replace with actual Platinum Pass link
      features: [
        { name: 'Startup Expo', included: true },
        { name: 'LHC Speakers Sessions', included: true },
        { name: 'Informals', included: true },

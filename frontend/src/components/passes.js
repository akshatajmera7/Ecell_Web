...
const PricingPasses = () => {
  ...
  const passes = [
    ...
    },
    {
      ...
      description: "Entry to all Workshop + Entry to Hackathon",
      gradient: "from-blue-300 to-blue-100",
      bgGradient: "from-blue-900 to-blue-800",
      category: "bv",
    },
    {
      ...
      description: "Entry to all Workshop + Entry to Hackathon + Internship Drive",
      gradient: "from-blue-300 to-blue-100",
      bgGradient: "from-blue-900 to-blue-800",
      category: "bv",
    },
    {
      ...
      description: "Entry to all Workshop + Entry to Hackathon + Internship Drive + Accommodation and food",
      gradient: "from-blue-300 to-blue-100",
      bgGradient: "from-blue-900 to-blue-800",
      category: "bv",
    },

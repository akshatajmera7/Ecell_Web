...
const EventsHero = () => {
  return (
    <div className="pt-40 pb-20 px-6 flex items-center justify-center bg-ecell-bg text-white overflow-hidden relative">
      <div className="max-w-7xl mx-auto w-full flex flex-col md:flex-row justify-between items-end gap-8 relative z-10">
        <motion.div
        ...
        <motion.div
          ...
          className="md:max-w-md text-right md:pb-4"
        >
          <p className="text-xl md:text-2xl font-light font-manrope text-gray-400 leading-relaxed">

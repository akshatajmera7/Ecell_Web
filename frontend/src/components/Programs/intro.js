...
const Intro = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-ecell-bg text-ecell-text">
      ...
      >
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-medium mb-8 leading-tight text-ecell-text">
          Our 
          <br />
          Programs and Initiatives
        </h1>
        <div className="max-w-3xl mx-auto">
          <p className="text-lg md:text-xl leading-relaxed text-ecell-text opacity-80">
